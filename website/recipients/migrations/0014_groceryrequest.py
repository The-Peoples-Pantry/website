    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('can_meet_for_delivery', models.BooleanField(help_text='We care about safety. Thus, we try to avoid delivery volunteers going into buildings or houses. Would you / the person requiring support be able to meet the delivery person in the lobby or door of the residence?', verbose_name='Able to meet delivery driver')),
                ...
                ('available_days', models.CharField(help_text="What days are you (or the person you're requesting for) available for receiving the delivery?", max_length=256, verbose_name='Available days')),
                ('available_time_periods', models.CharField(help_text="What times are you (or the person you're requesting for) available for receiving the delivery?", max_length=256, verbose_name='Available time periods')),
                ...
                ('vegetables', models.CharField(help_text='Select all that you want', max_length=256, verbose_name='Vegetables')),
                ('fruits', models.CharField(help_text='Select all that you want', max_length=256, verbose_name='Fruits')),
                ('protein', models.CharField(choices=[('Beef', 'Beef'), ('Chicken', 'Chicken'), ('Tofu', 'Tofu'), ('Eggs', 'Eggs')], help_text='Select one of the following', max_length=256, verbose_name='Protein')),
                ('grains', models.CharField(help_text='Select up to 3', max_length=256, verbose_name='Grains')),
                ('condiments', models.CharField(help_text='Select all that you want', max_length=256, verbose_name='Condiments')),
                ('dairy', models.CharField(choices=[('Milk', 'Milk'), ('Almond Milk', 'Almond Milk')], help_text='Select one of the following', max_length=256, verbose_name='Dairy')),
            ],
            options={
                'abstract': False,
            },
