...
API_KEY = "xvB2VYxUF6mByw32kqOszrCXfgC7CuUa"
...
def reverse_geocode(coords, api_key=API_KEY, include_nearest_intersection=False):
    return requests.get(
...
def geocode_anonymized(address, api_key=API_KEY):
...
def nearest_intersection(address, api_key=API_KEY):
